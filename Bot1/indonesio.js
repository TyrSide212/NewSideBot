...
const smsLista1 = () => { return `🌟 INFORMASI Side-Bot 🌟`}
...
const smsLista7 = () => { return `🐈 PASANG Side-Bot 🐈`}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan Side-Bot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan Side-Bot di Grup`}
...
const smsContacto4 = () => { return 'Kontak Resmi Side-Bot 🐈'}
