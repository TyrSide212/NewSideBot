...
console.error("Errore al obtener el buffer", error);
throw new Errore("Errore al obtener el buffer");
}}
...
console.error("Errore al obtener el tamaño del archivo", error)
return 0
}}
...
throw new Errore("No se pudo obtener información del video desde Invidious")
}}
