...
try{
let texto = `${lenguajeGB['smskick1']()}${usedPrefix + command} @${global.Tyr[0][0]}*`
...
if(conn.user.jid.includes(mentioned)) return conn.reply(m.chat, `${lenguajeGB['smskick1']()}${usedPrefix + command} @${global.Tyr[0][0]}*`, fkontak, m)
