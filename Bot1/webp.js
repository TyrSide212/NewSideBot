...
class Image {
  ...
  demuxAnim(path, frame = -1, prefix = '#FNAME#') {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (end == 0) {
        throw new Errore('This WebP isn\'t an animation');
      }
  ...
  replaceFrame(path, frame) {
    ...
    return _asyncToGenerator(function* () {
      if (!_this3.hasAnim) {
        throw new Errore('WebP isn\'t animated');
      }
      ...
      switch (r.type) {
        ...
        case constants.TYPE_EXTENDED:
          if (r.hasAnim) {
            throw new Errore('Merging animations not currently supported');
          }

          break;

        default:
          throw new Errore('Unknown WebP type');
      }
      ...
      switch (_this3.anim.frames[frame].type) {
        ...
        default:
          throw new Errore('Unknown frame type');
      }
  ...
  static muxAnim({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (frames.length == 0) {
        throw new Errore('No frames to mux');
      } else if (_width <= 0 || _width > 1 << 24) {
        throw new Errore('Width out of range');
      } else if (_height <= 0 || _height > 1 << 24) {
        throw new Errore('Height out of range');
      } else if (_height * _width > Math.pow(2, 32) - 1) {
        throw new Errore(`Width*height too large (${_width}, ${_height})`);
      } else if (loops < 0 || loops >= 1 << 24) {
        throw new Errore('Loops out of range');
      } else if (delay < 0 || delay >= 1 << 24) {
        throw new Errore('Delay out of range');
      } else if (x < 0 || x >= 1 << 24) {
        throw new Errore('X out of range');
      } else if (y < 0 || y >= 1 << 24) {
        throw new Errore('Y out of range');
      }
      ...
      for (let i = 0, l = frames.length; i < l; i++) {
        ...
        if (delay < 0 || delay >= 1 << 24) {
          throw new Errore(`Delay out of range on frame ${i}`);
        } else if (x < 0 || x >= 1 << 24) {
          throw new Errore(`X out of range on frame ${i}`);
        } else if (y < 0 || y >= 1 << 24) {
          throw new Errore(`Y out of range on frame ${i}`);
        }
        ...
        switch (img.data.type) {
          ...
          default:
            throw new Errore('Unknown image type');
        }
...
var _convertToExtended2 = function _convertToExtended2() {
  if (!this.loaded) {
    throw new Errore('No image loaded');
  }
...
var _demuxFrame2 = /* #__PURE__*/ (function() {
  const _demuxFrame3 = _asyncToGenerator(function* (path, frame) {
    ...
    if (frame.vp8l) {
      ...
      throw new Errore('Frame has no VP8/VP8L?');
    }
...
const _readHeader2 = /* #__PURE__*/ (function() {
  const _readHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (bytesRead != 12) {
      throw new Errore('Reached end of file while reading header');
    }

    if (buf.toString('utf8', 0, 4) != 'RIFF') {
      throw new Errore('Bad header (not RIFF)');
    }

    if (buf.toString('utf8', 8, 12) != 'WEBP') {
      throw new Errore('Bad header (not WEBP)');
    }
...
const _readChunkHeader2 = /* #__PURE__*/ (function() {
  const _readChunkHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (bytesRead == 0) {
      ...
      throw new Errore('Reached end of file while reading chunk header');
    }
...
const _readChunk_raw2 = /* #__PURE__*/ (function() {
  const _readChunk_raw3 = _asyncToGenerator(function* (n, fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore(`Reached end of file while reading ${n} chunk`);
    }
...
const _readChunk_VP2 = /* #__PURE__*/ (function() {
  const _readChunk_VP3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore('Reached end of file while reading VP8 chunk');
    }
...
const _readChunk_VP8_buf2 = function _readChunk_VP8_buf2(buf, size, cursor) {
  if (cursor >= buf.length) {
    throw new Errore('Reached end of buffer while reading VP8 chunk');
  }
...
const _readChunk_VP8L2 = /* #__PURE__*/ (function() {
  const _readChunk_VP8L3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore('Reached end of file while reading VP8L chunk');
    }
...
const _readChunk_VP8L_buf2 = function _readChunk_VP8L_buf2(buf, size, cursor) {
  if (cursor >= buf.length) {
    throw new Errore('Reached end of buffer while reading VP8L chunk');
  }
...
const _readChunk_VP8X2 = /* #__PURE__*/ (function() {
  const _readChunk_VP8X3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore('Reached end of file while reading VP8X chunk');
    }
...
const _readChunk_ANIM2 = /* #__PURE__*/ (function() {
  const _readChunk_ANIM3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore('Reached end of file while reading ANIM chunk');
    }
...
const _readChunk_ANMF2 = /* #__PURE__*/ (function() {
  const _readChunk_ANMF3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore('Reached end of file while reading ANMF chunk');
    }
...
var _readChunk_ALPH_buf2 = function _readChunk_ALPH_buf2(buf, size, cursor) {
  if (cusor >= buf.length) {
    throw new Errore('Reached end of buffer while reading ALPH chunk');
  }
...
const _readChunk_Skip2 = /* #__PURE__*/ (function() {
  const _readChunk_Skip3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Errore('Reached end of file while skipping chunk');
    }
