...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/GataNina-Li/Side-Bot-MD\ncd Side-Bot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/GataNina-Li/Side-Bot-MD.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} Side-Bot-MD${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando Side-Bot!!\nStarting CatBot!!\n\033[0m"
npm start
