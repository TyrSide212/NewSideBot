...
const smsOwner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MI CREADOR(A) LO PUEDE USAR!!\`\`\`` }//Tyr
...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE Side-Bot 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR Side-Bot 🐈`}
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Side-Bot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar Side-Bot en Grupos`}
...
const smsPropban3 = (ownerNumber) => { return `${lenguajeGB.smsAvisoIIG()}😳 *NO PUEDO BANEAR AL Tyr @${ownerNumber} DE ${packname}*`}
...
const smsContacto2 = () => { return 'Soy Tyr de ' + packname + ' sí tienes alguna duda me la puedes decir ✌️'}
const smsContacto3 = () => { return '👑 Tyr'}
const smsContacto4 = () => { return 'Contacto Oficial de Side-Bot 🐈'}
