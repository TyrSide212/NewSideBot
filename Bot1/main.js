...
console.error('Errore loading database:', error);
} finally {
...
console.error('Errore saving database:', error)
} finally {
global.db.READ = false
}}
loadDatabase()
...
"RXJyb3I6IEJhZCBNQUM=", // "Errore: Bad MAC" 
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Side-Bot-MD', 'Edge', '20.0.04'] : methodCodeQR ? ['Side-Bot-MD', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
