...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO Side-Bot 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR O Side-Bot 🐈`}
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o Side-Bot`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o Side-Bot em Grupos`}
...
const smsContacto4 = () => { return 'Contato Oficial Side-Bot 🐈'}
