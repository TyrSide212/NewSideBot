...
const smsLista1 = () => { return `🌟 معلومات Side-Bot 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت Side-Bot 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز Side-Bot-MD - WhatsApp '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام Side-Bot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام Side-Bot في المجموعات`}
...
const smsContacto4 = () => { return 'جهة اتصال Side-Bot الرسمية 🐈'}
