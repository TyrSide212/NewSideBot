...
const smsOwner = () => { return `\`\`\`¡¡CETTE COMMANDE SEUL MON CRÉATEUR PEUT L\UTILISER!!\`\`\`` }//Tyr
...
const smsLista1 = () => { return `🌟 INFORMATIONS Side-Bot 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALLER Side-Bot 🐈`}
