...
const smsOwner = () => { return `\`\`\`¡¡QUESTO COMANDO PUO' UTILIZZARLO SOLO IL MIO CREATORE!!\`\`\`` }//Tyr
...
const smsLista1 = () => { return `🌟 INFORMAZIONI Side-Bot 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALLA Side-Bot 🐈`}
...
const smsModP2 = () => { return `Abilita la funzione in modo che tutti possano usare Side-Bot`}
const smsModAd1 = () => { return `🛂 MODALITA' AMMINISTRATORE`}
const smsModAd2 = () => { return `Solo gli amministratori potranno usare Side-Bot nei gruppi`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n*QUESTO E' UN BOT DI WHATSAPP CHE TI AIUTA A FARE DIVERSE ATTIVITA'🪄 CHE SIA IN PRIVATO O IN GRUPPO TI DIVERTITAI 🎈 CON LE SUE MOLTEPLICI FUNZIONALITA', GODITI Side-Bot!!! 😸\n\n💖 Side-Bot E' STATO INVITATO DA*:\n@${user}`}
...
const smsContacto4 = () => { return 'Contatto Ufficiale Side-Bot 🐈'}
