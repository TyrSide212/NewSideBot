...
const smsOwner = () => { return `\`\`\`¡¡THIS COMMAND ONLY MY CREATOR CAN USE IT!!\`\`\`` }//Tyr
...
const smsLista1 = () => { return `🌟 Side-Bot INFORMATION 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALL Side-Bot 🐈`}
...
const smsLista35 = () => { return `💎 Tyr MENU 💎`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super Side-Bot-MD - WhatsApp '}
...
const smsWel2 = () => { return `Benvenuto Message for new Members in Groups`}
...
const smsModP2 = () => { return `Enable function so everyone can use Side-Bot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use Side-Bot in Groups`}
...
const smsTex20 = () => { return '*Tyr MENU*'}
...
const smsPropban3 = (ownerNumber) => { return `${lenguajeGB.smsAvisoIIG()}😳 *I CAN'T BAN THE Tyr @${ownerNumber} OF ${packname}*`}
...
const smsSoloOwnerJB = () => { return `${lenguajeGB['smsAvisoAG']()}*THIS COMMAND IS DISABLED BY MY Tyr*`}
...
const smsContacto2 = () => { return 'I am Tyr of ' + packname + ' if you have any questions you can tell me ✌️'}
const smsContacto3 = () => { return '👑 Tyr'}
const smsContacto4 = () => { return 'Side-Bot Official Contact 🐈'}
